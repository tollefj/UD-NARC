...
if __name__ == "__main__":
    ...
    parser.add_argument("--norne", "-n", type=str,
                        help="Source for NorNE data", default="../../norne/ud")
    parser.add_argument("--ud", "-u", type=str,
                        help="Source for UD data", default="../../UD")
    parser.add_argument("--output", "-o", type=str,
                        help="Merged files location", default="../../data/norne-merged")
    ...
    for lang in ["bokmaal", "nynorsk"]:
        ...
        NORNE = get_paths(os.path.join(args.norne, norne_id))
        UD = get_paths(os.path.join(args.ud, ud_id))
        ...
        for split in ["train", "test", "dev"]:
            ...
            out = os.path.join(args.output, out_filename)
