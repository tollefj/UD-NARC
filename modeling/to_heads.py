...
if __name__ == "__main__":
    ...
    path = os.path.join("data", "narc_wordlevel", "narc_{}{}.jsonl")
    for split in SPLITS:
            ...
            with jsonlines.open(path.format(split, "_head"), mode="w") as outf:
                ...
                for doc in inf:
                    ...
                    for head, spans in head2spans.items():
                        ...
                        spans.sort(key=lambda x: x[0][1] - x[0][0])
                    ...
                    deleted_clusters += len(head_clusters) - \
                        len(filtered_head_clusters)
